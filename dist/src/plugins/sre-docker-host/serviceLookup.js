 ...
 */
export function parseComposeServices(content, filePath) {
...
export function discoverServices(workspacePath) {
    const services = [];
...
export function findServiceByContainer(services, containerName) {
    return services.find((s) => s.name === containerName || containerName.includes(s.name));
}
