import type { CustomAgentDefinition } from "../../app/plugins/types.js";

/* ------------------------------------------------------------------ */
/*  SRE Researcher — read-only inspection agent                        */
/* ------------------------------------------------------------------ */

export const sreResearcher: CustomAgentDefinition = {
  name: "sre-researcher",
  description:
    "Read-only SRE research agent with Docker inspect, logs, and metrics access",
...
export const sreRemediator: CustomAgentDefinition = {
  name: "sre-remediator",
  description:
    "SRE remediation agent with restart, diagnostics, and verification capabilities",
...
export const reportWriter: CustomAgentDefinition = {
  name: "report-writer",
  description:
    "Report generation agent for SRE summaries and analyses",
