import type { WatcherDefinition } from "../../app/plugins/types.js";
import { getEvents, type DockerEvent } from "../../adapters/docker.js";
import { processAlert, type IncidentEngineConfig } from "../../worker/incidentEngine.js";
...
function normalizeDockerEvent(event: DockerEvent): NormalizedAlert | null {
  const containerName =
    event.Actor.Attributes.name ?? event.Actor.ID.slice(0, 12);
